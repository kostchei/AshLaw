...
Standard damage represents bruising, fatigue, and minor cuts. Most attack/armour
columns are linear; the animal tables use a small quadratic term where their
source curves are measurably convex.

```text
z = max(0, Net Roll - Damage Origin)
Hits = max(0, floor(Multiplier * z + Quadratic * z²))
```

* **Hit Threshold:** The minimum Net Roll that counts as a damaging hit.
* **Damage Origin:** The horizontal offset of the fitted curve. It is separate
  from Hit Threshold so the fit preserves both the first damaging result and the
  high-end slope.
* **Multiplier / Quadratic:** Linear and convex terms fitted against the complete
  source column. A zero Quadratic value is a purely linear fit.

The source transcription and measured errors are in
[`docs/reference/attack-chart-reference.md`](../../../docs/reference/attack-chart-reference.md).
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 10 | 8 | 0.581 | 0 | 23 | 2 |
| **Chain** | 11 | 10 | 0.931 | 0 | 21 | 2 |
| **Leather** | 13 | 11 | 1.251 | 0 | 18 | 2 |
| **None** | 16 | 13 | 1.808 | 0 | 17 | 2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 7 | 7 | 0.728 | 0 | 22 | 2 |
| **Chain** | 9 | 7 | 0.960 | 0 | 20 | 2 |
| **Leather** | 14 | 11 | 1.071 | 0 | 18 | 2 |
| **None** | 17 | 13 | 1.403 | 0 | 19 | 2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 12 | 10 | 1.121 | 0 | 22 | 2 |
| **Chain** | 14 | 12 | 1.869 | 0 | 20 | 2 |
| **Leather** | 15 | 13 | 2.429 | 0 | 17 | 2 |
| **None** | 17 | 14 | 3.010 | 0 | 17 | 2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 15 | 13 | 0.920 | 0 | 22 | 2 |
| **Chain** | 16 | 14 | 1.583 | 0 | 20 | 2 |
| **Leather** | 17 | 14 | 1.673 | 0 | 18 | 2 |
| **None** | 19 | 16 | 2.003 | 0 | 19 | 2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 12 | 10 | 0.227 | 0.050 | 21 | 2 |
| **Chain** | 13 | 9 | 0.055 | 0.062 | 20 | 2 |
| **Leather** | 12 | 9 | 0.314 | 0.059 | 18 | 2 |
| **None** | 10 | 7 | 0.336 | 0.062 | 16 | 2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 12 | 10 | 0.151 | 0.035 | 14 | 3.5 |
| **Chain** | 14 | 12 | 0.355 | 0.050 | 17 | 3 |
| **Leather** | 14 | 12 | 0.553 | 0.056 | 20 | 2.5 |
| **None** | 13 | 15 | 2.077 | 0 | 21 | 3 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 8 | 5 | 0.698 | 0 | 13 | 4 |
| **Chain** | 9 | 10 | 1.052 | 0 | 15 | 3.5 |
| **Leather** | 11 | 11 | 1.391 | 0 | 15 | 3 |
| **None** | 13 | 10 | 1.808 | 0 | 13 | 2.2 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 4 | 1 | 0.939 | 0 | 7 | 3.5 |
| **Chain** | 5 | 2 | 0.936 | 0 | 8 | 3.2 |
| **Leather** | 6 | 3 | 0.910 | 0 | 9 | 3 |
| **None** | 2 | 1 | 1.251 | 0 | 5 | 3.8 |
...
| Armor | Hit | Origin | Linear | Quadratic | Base Crit A | Crit Interval |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Plate** | 12 | 12 | 1.5 | 0 | 17 | 3 |
| **Chain** | 10 | 10 | 1.5 | 0 | 16 | 3 |
| **Leather** | 8 | 8 | 1.5 | 0 | 15 | 3 |
| **None** | 6 | 6 | 1.5 | 0 | 14 | 3 |
...
* Net Roll = 18 with 2-Handed Weapon vs Plate (`Hit = 12`, `Origin = 10`, `Linear = 1.121`, `Quadratic = 0`, `Base Crit A = 22`, `Interval = 2`).
* `z = 18 - 10 = 8`; Hits = `floor(1.121 * 8)` = **8 Hits**.
* Crit Tier = `floor((18 - 22) / 2)` = **-2 (No Crit)**.

### Scenario 2: RETIRED — Giant Squid Tentacle vs Leather

**Retired 29 July 2026. This scenario is invalid and must not be used as a test
fixture.** Its quoted parameters (`Hit Threshold 8`, multiplier `1.8`, Base Crit A
`17`, interval `2`) match no attack/armor row in this rules package, and its quoted
trauma text is absent from the authoritative physical critical CSVs.

The likely intended category is AT-6 Grappling & Unbalancing. Using its authoritative
Leather values with Raw d20 17 and Attack Mod +5 gives:

* Net Roll = `17 + 5 = 22` (`Hit = 14`, `Origin = 12`, `Linear = 0.553`, `Quadratic = 0.056`, Base Crit A = `20`, interval `2.5`).
* `z = 22 - 12 = 10`; Hits = `floor(0.553 * 10 + 0.056 * 10²)` = **11 Hits**.
* Crit Tier = `floor((22 - 20) / 2.5)` = **0 (Tier A Severity)**.
* Sub-Result Index = `17 % 10` = **7**.
* Result from `ct_4_unbalancing_critical_table.csv` (Tier A, Index 7):
  *"Blow to shield arm. +5 hits. Shield torn away. If no shield: +8 hits and stunned 2 rounds."*
