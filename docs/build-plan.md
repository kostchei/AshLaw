...
- Project settings: `display/window/stretch/mode = viewport`,
  `stretch/aspect = keep`, `stretch/scale_mode = integer`, base resolution **320×200**.
- Every texture: `Nearest` filtering, mipmaps off.
- Gumps render **inside** the same 320×200 viewport — they are pixel art, not modern UI.
...
2. 320×200 viewport, integer scaling, letterbox, nearest filtering everywhere.
